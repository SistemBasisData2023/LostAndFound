...
<div 
id="user-activity-section"
className="mt-12 md:col-span-2 bg-[#444C5C]">
  <p className="text-white font-bold text-4xl text-center mt-16 mb-10 font-serif">User Activity</p>
  <div className="flex justify-center items-center">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-8 pb-36 px-36"> 
      ...
      <div className="flex flex-col justify-center items-center bg-white rounded-xl shadow-md cursor-pointer square-container hover:shadow-lg transform hover:-translate-y-1 hover:scale-105 transition-all duration-300">
        <img src="../src/assets/reportlosticon.png" alt="Insert Lost Item" className="w-full h-full object-cover" />
        <p className="text-gray-700 font-semibold mt-4">Insert Lost Item</p>
        <button
          onClick={handleUserInsertLost}
          className="bg-gray-300 text-gray-800 font-bold py-2 px-8 rounded-t-full mt-4 transition-all duration-300 hover:bg-blue-900 hover:text-white "
        >
          Go
        </button>
      </div>
      ...
      {/* Insert Found Item */}
      <div className="flex flex-col justify-center items-center bg-white rounded-xl shadow-md cursor-pointer square-container hover:shadow-lg transform hover:-translate-y-1 hover:scale-105 transition-all duration-300">
        <img src="../src/assets/reportfoundicon.png" alt="Insert Found Item" className="w-full h-full object-cover" />
        <p className="text-gray-700 font-semibold mt-4">Insert Found Item</p>
        <button
            onClick={handleUserInsertFound}
          className="bg-gray-300 text-gray-800 font-bold py-2 px-8 rounded-t-full mt-4 transition-all duration-300 hover:bg-blue-900 hover:text-white"
        >
          Go
        </button>
      ...
      {/* See Lost Items */}
      <div className="flex flex-col justify-center items-center bg-white rounded-xl shadow-md cursor-pointer square-container hover:shadow-lg transform hover:-translate-y-1 hover:scale-105 transition-all duration-300">
        <img src="../src/assets/losticon.png" alt="See Lost Items" className="w-full h-full object-cover" />
        <p className="text-gray-700 font-semibold mt-4">See Lost Items</p>
        <button
            onClick={handleUserListLost}
          className="bg-gray-300 text-gray-800 font-bold py-2 px-8 rounded-t-full mt-4 transition-all duration-300 hover:bg-blue-900 hover:text-white"
        >
          Go
        </button>
      ...
      {/* See Found Items */}
      <div className="flex flex-col justify-center items-center bg-white rounded-xl shadow-md cursor-pointer square-container hover:shadow-lg transform hover:-translate-y-1 hover:scale-105 transition-all duration-300">
        <img src="../src/assets/foundicon.png" alt="See Found Items" className="w-full h-full object-cover" />
        <p className="text-gray-700 font-semibold mt-4">See Found Items</p>
        <button
            onClick={handleUserListFound}
          className="bg-gray-300 text-gray-800 font-bold py-2 px-8 rounded-t-full mt-4 transition-all duration-300 hover:bg-blue-900 hover:text-white"
        >
          Go
        </button>
